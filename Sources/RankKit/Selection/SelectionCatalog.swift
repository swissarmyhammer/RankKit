...
// `MetadataIndex<Item>` for RankKit's selection tier (plan.md §6 phase 3).
// New to RankKit -- there is no direct source file to port; this protocol
...
/// The catalog contract RankKit's selection tier drives its assembled prefix
...
/// snapshot type -- RankKit's own future retrieval types, or a consumer's
